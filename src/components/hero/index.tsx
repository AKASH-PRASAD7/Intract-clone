const Hero = () => {
  return (
    <section className=" hero-section relative bg-hero-pattern bg-cover bg-center h-screen flex flex-col items-center justify-center text-center">
      <div className="z-[1] mix-blend-screen w-[235px] transition-all ease duration-500 block align-middle max-w-full border-0">
        <img
          ...
          src="/intract_logo.gif"
          alt="intract-academy-logo"
        />
      </div>

      <p className="max-w-2xl text-lg mb-8 text-[#6B6A6A]">
      ...
      <button
        type="button"
        className="text-white flex justify-center  bg-[#7346ec] w-56 bg-opacity-50  focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center"
      >
